...
SOURCES = [
    ...
    },
    {
        ...
        "country": "CA",
        "region": "QC",
        "listing_path": "/OpportunityPublication/Search",
        "crawl_config": {
            "crawler_class": "seao",
            "weeks": 2,
            "rate_limit_seconds": 1,
        ...
        "industry_fit_score": 65,
        "health_status": "untested",
        "notes": "Québec's mandatory tendering system. Ingested from the Données Québec OCDS open-data weekly files (French titles; scorer has a French lexicon).",
    },
    {
        ...
        "health_status": "untested",
        "notes": "Alberta's provincial + municipal procurement portal (~1600 open postings). Public JSON search API with UNSPSC codes and full descriptions.",
    },
    {
        "name": "BidNet Direct",
        "source_type": "aggregator",
